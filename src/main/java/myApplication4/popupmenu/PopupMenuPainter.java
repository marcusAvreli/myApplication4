...
import myApplication4.style.framework.IStyle;
import myApplication4.style.framework.StyleManager;

public class PopupMenuPainter
{
	private static final Logger logger = LoggerFactory.getLogger(PopupMenuPainter.class);
	/**
	...
	public PopupMenuPainter(String title, IStyle style)
	{
		...
		this(title, 25, new Font(Font.SERIF, Font.BOLD, 9), style.getSelectionGradientColor(), style.getSelectionForeground(), style.getSelectionBackground());
	}
